...
cut5 = 'C://Users//brink//Downloads//#Z//workspace//Maid3D//cut5.mp4'
...
try: 
    button1 = Button(main_window, text="Video 1", command= lambda:replace_video(player=player, path_video = path_a))
    button1.pack()
    button2 = Button(main_window, text="Video 2", command= lambda:replace_video(player=player, path_video = path_b))
    button2.pack()
